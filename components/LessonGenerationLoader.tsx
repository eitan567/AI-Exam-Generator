...
const loadingMessages = [
    "מנתחים את חומר הלימוד...",
    "מנסחים שאלות מאתגרות...",
    "ממציאים מסיחים חכמים...",
    "מוודאים שהכל תקין פדגוגית...",
    "המבחן כמעט מוכן!"
];

const ExamGenerationLoader: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-zinc-900 text-center p-4">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-4">יוצרים עבורך מבחן חכם...</h2>
...
export default ExamGenerationLoader;
