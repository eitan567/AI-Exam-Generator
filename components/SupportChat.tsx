...
const SupportChat: React.FC<SupportChatProps> = ({ isOpen, onClose }) => {
    const [chatHistory, setChatHistory] = useState<ChatMessage[]>([
        { role: 'ai', text: 'שלום! אני כאן כדי לעזור. איך אפשר לסייע היום עם "יוצר המבחנים AI"?' }
    ]);
        ...
        <>
            ...
            <div className="p-3 bg-gray-50 dark:bg-zinc-800 border-t border-gray-200 dark:border-zinc-700">
                <div className="flex items-center gap-2 mb-2 px-1 flex-wrap">
                    ...
                    <button onClick={() => handleQuickSuggestionClick('איך אני עורך מבחן קיים?')} className="px-3 py-1 text-xs font-semibold text-gray-700 dark:text-gray-200 bg-blue-100 dark:bg-zinc-950 rounded-full hover:bg-blue-200 dark:hover:bg-zinc-600 transition-colors">
                        עריכת מבחן
                    </button>
